...
### UPDATE: [Thanks to Replit.com, you can now run Easy-MASM from your web browser](https://github.com/jere-mie/easy-masm/wiki/Replit)!

This is **the best way** to run MASM on MacOS, with 0 installation required to get running!
Check out [this article](https://github.com/jere-mie/easy-masm/wiki/Replit) for more info!

---

## Note: the following is outdated and only applies if you're interested in running Easy-MASM on your actual computer. I STRONGLY recommend you check out the [Replit section](https://github.com/jere-mie/easy-masm/wiki/Replit) to run Easy-MASM in your browser!
